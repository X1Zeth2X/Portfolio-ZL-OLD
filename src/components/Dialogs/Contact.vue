...
>
  <div class="f5">
    <a href="mailto:zeth.leonardo@protonmail.com">
      <vs-button type="relief" icon="email" class="mr2" 
        color="#EC96A4"
      ></vs-button>
    </a>
    ...
    <a href="https://github.com/x1zeth2x/" target="_blank">
      <vs-button type="relief" class="ml2 b" color="#5D535E">Github</vs-button>
    </a>
  </div>
  ...
  <div class="f5">
    <vs-input 
      v-for="info in contacts" :key="info.label"
...
export default class Contact extends Vue {
  @Action('closeContact', { namespace }) public close: any;
